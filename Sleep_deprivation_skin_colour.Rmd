...
mcmc.pval(as.mcmc(lightness.model,"b_SD1", combine_chains = T))
...
sjstats::hdi(as.mcmc(lightness.model,"sd_ID__Intercept", combine_chains = T), prob = 0.95)
...
mcmc.pval(as.mcmc(Redness.model,"b_SD1", combine_chains = T))
...
sjstats::hdi(as.mcmc(Redness.model,"sd_ID__Intercept", combine_chains = T), prob = 0.95)
...
mcmc.pval(as.mcmc(Yellowness.model,"b_SD1", combine_chains = T))
...
sjstats::hdi(as.mcmc(Yellowness.model,"sd_ID__Intercept", combine_chains = T), prob = 0.95)
```
